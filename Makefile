...
run_conv_gold_test: conv_gold_test
	./conv_gold_test

conv_gold_test: cpp/conv_gold.cpp cpp/conv_gold_test.cpp
	g++ -g -std=c++11 cpp/conv_gold_test.cpp -o conv_gold_test

run_conv_gold_tiled_test: conv_gold_tiled_test
	./conv_gold_tiled_test

conv_gold_tiled_test: cpp/conv_gold_tiled.cpp cpp/conv_gold_tiled_test.cpp
	g++ -g -std=c++11 cpp/conv_gold_tiled_test.cpp -o conv_gold_tiled_test
